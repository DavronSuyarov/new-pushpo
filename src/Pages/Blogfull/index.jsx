...
const Blogfull = () => {
  return (
    <div>
      ...
      {/*Breadcrumb Starts */}
      <div className='text-center breadcrumb-area'>
        <div className='bredcrumb-box'>
          <a href='#slider'>Home</a>
          <span className='lnr lnr-arrow-right' />
          <a href='#blog-home'>Blog Full Width</a>
        </div>
      </div>
      {/*Breadcrumb Ends */}
        ...
        <div className='row'>
          <div className='col-md-8'>
            ...
            <div className='single-post'>
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                eiusmod tempor incididunt elit labore et dolore magna aliqua. Ut
            ...
            {/* single post full width */}
            <div className='single-post'>
              <img src='assets/img/blog/full2.jpg' alt='' />
              <h2>Renovated Appartment</h2>
              <span className='lnr lnr-user' />
              <span>Mark James</span>
              <span className='lnr lnr-calendar-full' />
            ...
            {/* single post full width */}
            {/* Blog paginatio*/}
            <div className='text-center blog-pagination section-small'>
              <ul>
                <li>
                  <a href='#'>
          ...
          <div className='col-md-4'>
            ...
            <div className='widget widget-search'>
              <form name='search' method='get' action='#'>
                ...
                <button className='widget-search-btn blog-gradient'>
